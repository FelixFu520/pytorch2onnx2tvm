...
int main(void) {
    ...
    std::cout<<"load so!"<<"\n";
    tvm::runtime::Module mod_dylib = tvm::runtime::Module::LoadFromFile("../../models/mobilenet_rasp.so");

    std::cout<<"load json"<<"\n";
    std::ifstream json_in("../../models/mobilenet_rasp.json", std::ios::in);
    std::string json_data((std::istreambuf_iterator<char>(json_in)), std::istreambuf_iterator<char>());
    json_in.close();
  
    std::cout<<"load params"<<std::endl;
    std::ifstream params_in("../../models/mobilenet_rasp.params", std::ios::binary);
